                ...
                <>
                    ...
                    <div className="w-[95%] 800px:w-[85%] m-auto min-h-[70vh]">
                        <Heading
                            ...
                            description="E-learning is a platform for students to learn"
                            keywords="programming, coding skills, collaboration, growth"
                        />
                        <br />
                        ...
                        <br />
                        <br />
                        <div className="grid grid-cols-1 gap-[20px] md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] 1500px:gap-[35px] mb-12 border-0">
                            {
