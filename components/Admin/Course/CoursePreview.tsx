    ...
    <div className='w-[90%] m-auto py-5 mb-5' >
      <div className="w-full relative">
        ...
        <div className='flex items-center'>
          <h1 className='pt-5 text-[25px]'>{courseData?.price === 0 ? "Free":  "Rs." + courseData?.price }</h1>
      ...
      <div className='w-full'>
        ...
        <div className='w-full'>
          ...
          <p className='text-[18px] mt-[20px] whitespace-pre-pine w-full overflow-hidden'> {courseData?.description} </p>
        </div>
        <br />
        <br />
