    ...
    <div className='w-[80%] m-auto mt-24'>
      <form onSubmit={handleSubmit} className={`${styles.label}`}>
       ...
       <label htmlFor="">
        ...
        <input type="name" name="" required value={courseInfo.name} onChange={(e:any) => setCourseInfo({...courseInfo, name:e.target.value})} id="name" 
        placeholder="Mern stack" className={`${styles.input}`}  />
       </div>
       <br />
       <div className="mb-5">
        ...
        className={`${styles.input} !h-min !py-2`} value={courseInfo.description} onChange={(e:any)=>
       ...
       <div className='w-full flex justify-between'>
        <div className="w-[45%]">
          ...
          <input type="number" name='' required value={courseInfo.price} onChange={(e:any) =>
            setCourseInfo({...courseInfo, price: e.target.value})
          } id="price" placeholder='29'className={`${styles.input}`} />

        </div>
        <div className="w-[45%]">
          <label className={`${styles.label}`}>Estimated Price (optional)</label>
          <input type="number" name='' required value={courseInfo.estimatedPrice} onChange={(e:any) =>
       ...
       <div className='w-full flex justify-between'>
        ...
        <div className="w-[45%]">
          ...
          <input type="text" name='' required value={courseInfo.level} onChange={(e:any) =>
            setCourseInfo({...courseInfo, level: e.target.value})
          } id="level" placeholder='Beginner/Intermediate/Expert'className={`${styles.input}`} />

        </div>
        <div className="w-[45%]">
          <label className={`${styles.label}`}>Demo Url</label>
          <input type="text" name='' required value={courseInfo.demoUrl} onChange={(e:any) =>
            setCourseInfo({...courseInfo, demoUrl: e.target.value})
          } id="demoUrl" placeholder='gdhfhf'className={`${styles.input}`} />
        ...
        <div className='w-full'>
          ...
          >
            {courseInfo.thumbnail ? (
              ...
              <span className="text-black dark:text-white">Drag and drop your thumbnail or click to browser</span>
            )}
          </label>
        </div>
        <br />
