...
import AllInvoices from '../Order/AllInvoices'
 ...
 const CircularProgessWithLabel:FC<Props>=({open,value})=>{
    return (
        <Box sx={{position:"relatives", display:"inline-flex"}} >
            <CircularProgress 
            variant='determinate'
            value={value}
            size={45}
            ...
            <div className='pt-[80px] pr-8'>
                <div className='w-full dark:bg-[#111C43] rounded-sm shadow'>
                    ...
                    <div className=''>
                        ...
                        <h5 className='py-2 font-Poppins dark:text-[#fff) text-black text-[20px]'> Sales Obtained</h5>
                    </div>
                    <div>
                        <CircularProgessWithLabel value ={100} open={open} />
