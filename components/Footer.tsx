...
const Footer = (props: Props) => {
  return (
    <footer className="min-h-screen bg-white dark:bg-black"> {/* Ensure full-screen background and dark mode */}
      ...
      <div className='w-[95%] 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8'>
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className='space-y-3'>
            ...
            <ul className='space-y-4'>
              <li>
                <Link href="/courses" className="text-base text-black dark:text-gray-300 dark:hover:text-white">Facebook</Link>
              </li>
              <li>
                <Link href="/profile" className="text-base text-black dark:text-gray-300 dark:hover:text-white">Instagram</Link>
              </li>
              <li>
                <Link href="/course-dashboard" className="text-base text-black dark:text-gray-300 dark:hover:text-white">Github</Link>
              </li>
            </ul>
          </div>
          <div className='space-y-3'>
            <h3 className='text-[20px] font-[600] text-black dark:text-white'>Contact Info</h3>
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">Call us: 975463723</p>
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">Address: Thankot Chandaragiri near Tribhuvan Park</p>
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">Mail us: ross@gmail.com</p>
          </div>
        </div>
        <br />
        <p className="text-center text-black dark:text-white">Copyright 2023 Ross Gopali | All Rights Reserved</p>
      </div>
      <br />
    </footer>
  )
