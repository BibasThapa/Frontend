...
const CourseContentList:FC<Props> = (props) => {
  ...
  return (
    <div className={`mt-[15px] w-full ${!props.isDemo && 'ml-[-3opx] min-h-screen sticky top-24 left-0 z-30'}`}>
            ...
            {isSectionVisible && (
              <div className="w-full">
                {sectionVideos.map((item: any, index:number)=>{
                  ...
                  return (
                    <div  className={`w-full ${
                      videoIndex === props.activeVideo ? "bg-slate-800":""} cursor-pointer transition-all p-2`}
                      key={item._id}
